...
<html lang="en">
<head>
  <title>Compress & resize image for GATE form</title>
 ...
 <div class="modal fade" id="modal2" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('GATE'); hello('2');" data-dismiss="modal">
...
<div class="row " style="    align-items: center;margin-top: 100px;border-bottom:1px dashed lightgrey; padding-bottom: 15px;  font-weight: 600;" >
  <div class="col-sm-7 col-xs-12">
    <h3 style="font-weight: 600;margin-bottom: 40px;"  >Image conversion for GATE form</h3>
  </div>
...
<div class="row mt-3 text" style="background-color: #f62626; padding: 25px; color: white;">
    ...
    <div class="col-sm-8 col-xs-12">
      ...
      <h3>Resize and compress image for Graduate Aptitude Test in Engineering(GATE) form</h3>
      </div>
      <p class="text-center" style="display: inline-block;">Compress Graduate Aptitude Test in Engineering(GATE) photograph less than 200kb more than 5kb and resize photograph of maximum pixel resolution 480 x 640 (width 480px and height 640px) and minimum pixel resolution 240 x 320 (width 240px and height 320px) and compress Signature for GATE with size less than 200kb more than 5kb maximum pixel resolution 160 x 560 (width 160px and height 560px) and minimum pixel resolution 80 x 280 (width 80px and height 280px).</p>
    </div>
    <div class="col-sm-2 col-xs-12"></div>
  </div>
<div class="row mt-5">
