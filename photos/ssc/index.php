...
<html lang="en">
<head>
  <title>Compress & resize image for SSC form</title>
  <meta name="keywords" content="picture,image,jpeg,nda,na,nda/na,cds,ssc,du,aipmt,convert,resize,form,download">
  <meta name="description" content="Compress and Resize image for online forms- SSC, NDA/NA, CDS, AIPMT, SSC, DU etc..">
  <meta property="og:site_name" content="formpicture.com">
  <meta property="og:title" content="Compress and Resize Image for your form">
  <meta property="og:description" content="Image resizing and compression for online forms- SSC, NDA/NA, CDS, AIPMT, SSC, DU">
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="google-site-verification" content="KBhXLILOE_YOzJaKhgqUoL03wEXSbCJgoCaCIzqFw1k" />
 ...
 <div class="modal fade" id="modal1" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('SSC'); hello('1');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal2" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('SSC'); hello('2');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal3" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('SSC'); hello('3');" data-dismiss="modal">
            <span class="docs-tooltip" data-toggle="tooltip" title="cropper.getCroppedCanvas()">
              crop
            </span>
          </button>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" style="padding-right: 10px; padding-left: 150px; text-transform: uppercase; font-weight: 600; font-size: 16px;" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="#" style="color:#f62626 !important;">Photos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" style="color:#f62626 !important;">Documents</a>
      </li>
      <li class="nav-item">
...
<div class="row " style="    align-items: center;margin-top: 100px;border-bottom:1px dashed lightgrey; padding-bottom: 15px;  font-weight: 600;" >
  <div class="col-sm-7 col-xs-12">
    <h3 style="font-weight: 600;margin-bottom: 40px;"  >Image conversion for SSC form</h3>
  </div>
...
<div class="row mt-3 text" style="background-color: #f62626; padding: 25px; color: white;">
    ...
    <div class="col-sm-8 col-xs-12">
      ...
      <h3>Resize and compress image for SSC/Staff Selection Commission form</h3>
      </div>
      <p class="text-center" style="display: inline-block;">Image Dimension for Staff Selection Commission for photgraph width =100px and height =120px and for Signature width=140px and height =60px. Image size should be more than 1kb but less than 12kb Compress and resize to reach the desired output in just three clicks.</p>
    </div>
    <div class="col-sm-2 col-xs-12"></div>
  </div>
<div class="row mt-5">
