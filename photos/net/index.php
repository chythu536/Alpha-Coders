...
<html lang="en">
<head>
  <title>Compress & resize image for UGC NET form</title>
  <meta name="keywords" content="picture,image,ugc,net,under,graduate,level,jpeg,nda,na,nda/na,cds,ssc,du,aipmt,convert,form,resize,download">
  <meta name="description" content="Compress and Resize image for online forms- UGC NET, NDA/NA, CDS, AIPMT, SSC, DU etc..">
  <meta property="og:title" content="Compress and Resize Image for your form">
  <meta property="og:description" content="Image resizing and compression for online forms- UGC NET, NDA/NA, CDS, AIPMT, SSC, DU">
  <meta charset="utf-8">
 ...
 <div class="modal fade" id="modal1" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('NET'); hello('1');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal2" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('NET'); hello('2');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal3" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('NET'); hello('3');" data-dismiss="modal">
            <span class="docs-tooltip" data-toggle="tooltip" title="cropper.getCroppedCanvas()">
              crop
            </span>
          </button>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" style="padding-right: 10px; padding-left: 150px; text-transform: uppercase; font-weight: 600; font-size: 16px;" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="../../photos.php" style="color:#f62626 !important;">Photos</a>
      </li>
      <li class="nav-item">
...
<div class="row " style="    align-items: center;margin-top: 100px;border-bottom:1px dashed lightgrey; padding-bottom: 15px;  font-weight: 600;" >
  <div class="col-sm-7 col-xs-12">
    <h3 style="font-weight: 600;margin-bottom: 40px;"  >Image conversion for UGC NET form</h3>
  </div>
...
<div class="row mt-3 text" style="background-color: #f62626; padding: 25px; color: white;">
    ...
    <div class="col-sm-8 col-xs-12">
      ...
      <h3>Resize and compress image for UGC NET / Under Graduate Level - National Eligibility Test</h3>
      </div>
      <p class="text-center" style="display: inline-block;">Compress UGC NET /National Eligibility Test photograph less than 40kb and resize with dimension width 3.5cm and height 4.5cm and compress Signature for NET /National Eligibility Test to less than 30kb and with dimension width 3.5cm and height 1.5cm.</p>
    </div>
    <div class="col-sm-2 col-xs-12"></div>
  </div>
<div class="row mt-5">
