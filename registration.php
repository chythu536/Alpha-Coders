      ...
      <div class="has-shadow p-3" style="width: 100%; min-height: 250px;">
        ...
        <div class="row">
          ...
          <div class="col-md-12 text-right">
 			<div class="form-group">
 				Already registered? <a href="index.php">Login from</a> Here!
 			</div>         	
          </div>
          <div class="col-md-12 justify-content-center">
 			<div class="form-group">
 				<input class="btn btn-danger form-control" type="submit" name="register" value="Register">
 			</div>         	
          </div>
      </form>
    	</div>
...
<?php 
	if(isset($_POST['register'])){
		...
		$sql = "INSERT INTO `users` (`id`, `uname`, `email`, `pwd`) VALUES (NULL, '$uname', '$email', '$pwd');";
