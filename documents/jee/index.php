...
<html lang="en">
<head>
  <title>Compress & resize image for JEE Main form</title>
  <meta charset="utf-8">
 ...
 <div class="modal fade" id="modal1" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('JEE'); hello('1');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal2" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('JEE'); hello('2');" data-dismiss="modal">
 ...
 <div class="modal fade" id="modal3" role="dialog" aria-labelledby="modalLabel" tabindex="-1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <button type="button" class="btn btn-primary btncrp"  onclick=" select_form('JEE'); hello('3');" data-dismiss="modal">
            <span class="docs-tooltip" data-toggle="tooltip" title="cropper.getCroppedCanvas()">
              crop
            </span>
          </button>
...
<div class="row " style="    align-items: center;margin-top: 100px;border-bottom:1px dashed lightgrey; padding-bottom: 15px;  font-weight: 600;" >
  <div class="col-sm-7 col-xs-12">
    <h3 style="font-weight: 600;margin-bottom: 40px;"  >Document conversion for JEE Main form</h3>
  </div>
...
align-items: center;">Change Form: <span class="ml-1" id="list-form"></span>
    ...
    <div style="padding-left: 5px;border-left: 1px solid #f62626;"><a class="btn btn-fp btn-sm has-shadow" href = '../../custom.php'; style="background: #f62626; color: white;">Custom <i class="fas fa-crop-alt"></i></a></div>
  </div>
</div>
<div class="row mt-3 text" style="background-color: #f62626; padding: 25px; color: white;">
    ...
    <div class="col-sm-8 col-xs-12">
      ...
      <h3>Resize and compress image for JEE Main / Joint Entrance Exam</h3>
      </div>
      <p class="text-center" style="display: inline-block;">Compress JEE Main / Joint Entrance Exam Test photograph less than 40kb and resize with dimension width 3.5cm and height 4.5cm and compress Signature for JEE Main / Joint Entrance Exam to less than 30kb and with dimension width 3.5cm and height 1.5cm.
</p>
    </div>
    <div class="col-sm-2 col-xs-12"></div>
  </div>
